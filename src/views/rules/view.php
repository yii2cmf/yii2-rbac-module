    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            [
                ...
                'value' => function ($data, $widget) {
                    return Yii::$app->formatter->asDatetime(new DateTime(date('Y-m-d H:i', $data->created_at)));
                },
            ],
            [
                'attribute' => 'updated_at',
                'value' => function ($data, $widget) {
                    return Yii::$app->formatter->asDatetime(new DateTime(date('Y-m-d H:i', $data->updated_at)));
                },
            ],
            //'data',
        ],
